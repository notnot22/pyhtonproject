...
if st.button("Button Clicked"):
    ...
    if st.session_state.click_count >= 22:
        ...
        yang paling aku sayanggg dan yang paling aku cintaa beneran beneran beneran beneran beneran beneran beneran beneran beneran beneran beneran beneran beneran.
        """
